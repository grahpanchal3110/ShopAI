...
function normalizeImageUrl(u: string) {
  ...
  // Convert Unsplash photo page URL -> direct image URL
  // https://unsplash.com/photos/<id>  => https://source.unsplash.com/<id>/1080x1080
  const m = url.match(/^https?:\/\/unsplash\.com\/photos\/([a-zA-Z0-9_-]+)/);
  if (m?.[1]) return `https://source.unsplash.com/${m[1]}/1080x1080`;

  // If already using source.unsplash.com but without size, keep it (or you can enforce size)
  // If other URLs, pass through
  return url;
}
